...
function completed() {
    ...
    const level = parseInt($("#level span").html());
    const moves = parseInt($("#moves span").html());
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    if (user) {
        ...
        document.getElementById("tg_user").innerText = `Игрок: ${username}`;
        console.log("Telegram user ID:", user.id);
    } else {
        document.getElementById("tg_user").innerText = "Гость";
    }
});
